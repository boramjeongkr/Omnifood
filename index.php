...
<html lang="en">
            ...
            <div class="row">
                ...
                <div class="col span-1-of-2">
                    <ul class="social-links">
                        <li><a href="http://facebook.com/boramjeongkr"><i class="ion-social-facebook"></i></a></li>
                        <li><a href="#"><i class="ion-social-twitter"></i></a></li>
                        <li><a href="#"><i class="ion-social-googleplus"></i></a></li>
                        <li><a href="https://www.instagram.com/boramjeongkr/"><i class="ion-social-instagram"></i></a></li>
                    </ul>
                </div>
            </div>
            <div class="row">
                <p>
                    Copyright &copy; 2017 by Boram Jeong with <i class="ion-coffee"></i>  All rights reserved.
                </p>
            </div>
        </footer>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAoQXveF_c6mVI4gP7UNlsaC5b4FLvy9OY"></script>
